"use client"
import { ClipboardList, Code, Trophy, Brain, Target, Users } from "lucide-react"
...
const timelineEvents = [
  {
    ...
    icon: ClipboardList,
    color: "from-[#010084]/20 to-[#C4E2ED]/20",
    time: "09:00 AM",
  },
  {
    date: "April 5th, 2025",
...
export default function HackathonTimeline() {
  return (
    <section
      className="relative py-20 px-4 bg-gradient-to-b from-[#010084] via-[#010084]/90 to-[#010084]"
      id="timeline"
    >
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute w-full h-full bg-[radial-gradient(circle_at_50%_120%,rgba(196,226,237,0.2),rgba(255,255,255,0))]" />
      </div>

      <div className="container mx-auto max-w-6xl relative z-10">
        <h2 className="text-4xl md:text-5xl font-bold text-center mb-16">
          <span className="bg-gradient-to-r from-[#C4E2ED] via-white to-[#C4E2ED] text-transparent bg-clip-text">
            Event Timeline
          </span>
        </h2>
        ...
        <div className="relative">
          {/* Vertical Line */}
          <div className="absolute left-1/2 transform -translate-x-1/2 h-full w-px bg-gradient-to-b from-transparent via-[#C4E2ED]/50 to-transparent" />
